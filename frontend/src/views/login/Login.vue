<template>
  <div>
    <!-- <div style="display: flex;width: 100%;justify-content: center;padding: 10px;" >
      <a-menu mode="horizontal" :selectedKeys="selectedKeys" @click="change_zhuce">
    ...
    <div v-else style="display: flex;flex-direction: column;">
      ...
      <div style="display: flex;flex-direction: row;width: 70%;margin-left: 10%;align-items: center;margin-top: 20px">
        ...
        <div style="display: flex;flex-direction: row;margin-left: 5px;">
          ...
          <a-button v-if="!is_send" @click="send_email" type="primary" size="large"
            style="width: 100px;margin-left: 20px;">发送</a-button>
          <a-button v-else type="primary" size="large"
            style="width: 100px;margin-left: 20px;background-color: #FFFFFF;color:black;">{{ second }}</a-button>
        </div>
      ...
      <div style="width: 100%;display: flex;flex-direction: row;justify-content: center;margin-top: 40px;">
        <a-button type="primary" size="large" :loading="isLoading" style="width: 200px;"
          @click="register_user">注册</a-button>
      </div>
